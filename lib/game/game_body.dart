...
import 'package:study_rsp_game/game/widget/cpu_input.dart';
import 'package:study_rsp_game/game/widget/game_result.dart';
import 'package:study_rsp_game/game/widget/user_input.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(child: GameResult(isDone: isDone, callback: reset, result: getResult())),
